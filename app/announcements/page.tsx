      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400 mb-6">
            Announcements section is under development. Soon badge holders will be able to post official announcements that reach everyone instantly!
          </p>
          
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 mb-6">
            <h3 className="text-lg font-semibold mb-3 text-orange-500">Planned Features:</h3>
            <ul className="text-left text-sm text-gray-300 space-y-2">
              <li>✅ Badge holders can post announcements</li>
              <li>✅ Push notifications for all users</li>
              <li>✅ Permanent storage (never expires)</li>
