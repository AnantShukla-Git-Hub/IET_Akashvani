  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="bg-[#1a1a1a] border-b border-[#2a2a2a] px-4 py-4">
        <h1 className="text-2xl font-bold text-orange-500">💬 Discussion Rooms</h1>
        <p className="text-sm text-gray-400 mt-1">WhatsApp-style group chats</p>
      </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400 mb-6">
            Discussion rooms are under development. Soon you'll be able to chat with your classmates, branch mates, and join cross-branch rooms for placements, mess, and more!
          </p>
          
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6 mb-6">
            <h3 className="text-lg font-semibold mb-3 text-orange-500">Planned Features:</h3>
            <ul className="text-left text-sm text-gray-300 space-y-2">
              <li>✅ Class rooms (CSE 1st Year, etc.)</li>
              <li>✅ Branch rooms (All CSE students)</li>
              <li>✅ Cross-branch rooms (Placements, Mess, etc.)</li>
